...
def build_model():
    ...
    return model
model1=build_model()
model1.load_weights('C:/Users/Administrator/Desktop/homework/weight/A.h5')
...
def read_image(imageName):
    ...
    return data
images=[]
images.append(read_image("C:/Users/Administrator/Desktop/homework/data/A.png"))

X = np.array(images)
pre = model1.predict(X)

misc.imsave('C:/Users/Administrator/Desktop/homework/resultA/3160104051_A.png', pre[0])