...
for i in range(1,2001):
    images.append(read_image('/Users/HZK/YBJ/image_recovery/trainA/dog_'+str(i)+'.jpg'))
    labels.append(read_image('/Users/HZK/YBJ/image_recovery/labelA1/dog_'+str(i)+'.jpg'))
...
model.save_weights("/Users/HZK/YBJ/image_recovery/network/third_tryA.h5")