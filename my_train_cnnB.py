...
for i in range(1,2001):
    images.append(read_image('/Users/HZK/YBJ/image_recovery/trainB/dog_'+str(i)+'.jpg'))
    labels.append(read_image('/Users/HZK/YBJ/image_recovery/labelB1/dog_'+str(i)+'.jpg'))
...
model.save_weights("/Users/HZK/YBJ/image_recovery/network/B_2000_4layers.h5")